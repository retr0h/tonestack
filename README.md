...
- [`schemas/`](schemas/) holds the RigSpec contract, the generated device
  catalog, and the preset corpus.
- [`recipes/`](recipes/) holds the curated rigs that ship in the binary.
