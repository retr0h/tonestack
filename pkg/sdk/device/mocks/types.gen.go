...
import (
	...
	device "github.com/retr0h/tonestack/pkg/sdk/device"
...
func (m *MockLister) List(ctx context.Context) ([]device.Descriptor, error) {
	m.ctrl.T.Helper()
...
// List mocks base method.
func (m *MockBus) List(ctx context.Context) ([]device.Descriptor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx)
	ret0, _ := ret[0].([]device.Descriptor)
	ret1, _ := ret[1].(error)
...
func (m *MockEditor) Model() device.Model {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Model")
	ret0, _ := ret[0].(device.Model)
	return ret0
}
